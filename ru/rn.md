...
На самом деле аналог "финала" совсем ничем не выделяется на фоне раунда. В нём только действует бонус к доходам и исследованиям, благодаря чему можно более
комфортно поиграть в конце. Какого-либо соревнования колоний в финале нет и бонусов за топ-колонию не предусмотрено.
...
В качестве производств выступают заставы (аванпосты, outpost). Тут тоже есть подвозы, они тут тоже помогают снижать ВО. Однако застава может производить несколько
разных ресурсов. Например, лаборатория электролиза производит водород и кислород, а в последующих фазах также хлор.
...
чего-то ожидать от 5 минут низкого ВО. Тем более, что и собственно нулевого ВО тут не бывает: в нераспечатанной заставе действует базовое ВО 30 секунд.
...
ВО тут считается по другим принципам, некоторые из которых покажутся непривычными. Базовое ВО 30 секунд, но нет никакого отрицательного значаения от загруженности,
её вклад всегда положителен. ВО не зависит от запасов на складе, зато зависит от соотношения подвоз-вывоз. Если оно ниже 50%, корректировка ВО имеет положительное
значение, если выше 50% - отрицательное. Своего рода аналог интеграции в RN. При высоком подвозе можно сократить ВО очень существенно, поэтому в этой игре принято
...
и сумма инвестиций гильдии (guild shares), а также КП (leading guild). Кроме того, есть ещё интересные механики на основе дронов (сокращают ВО игроку и преимушество
в числе дронов на конкретной заставе перед другими гильдиями сокращает ВО всей гильдии) и "пожар" (прибавляет 120 секунд к ВО всем, его надо тушить совместно с помощью
дронов). Также гильдия может заявить права на один аванпост (это называется claim) и получить на нём дополнительное снижение ВО.

## Транспортёры, дроны, лицензии

Ресы тут перевозят транспортёры. В отличие от RN, их всего 4 вида в каждой фазе: универсальный и три специализированных. Специализированные более эффективны, чем
...
Аналога ускорения нет. Самая незнакомая характеристика - это эффективность: она сокращает время погрузки, то есть это дополнительный множетель к ВО для конкретного
транспортёра.

Есть премиумные транспортёры, не требующие слотов в ангаре. Их называют "прототипами". Достать их можно в контейнерах или невыгодно ха премвалюту.

В игре также есть дроны: они нужны для строительства застав, для тушения пожаров для них, они могут дополнительно уменьшать ВО. В поздних фазах есть ещё шпионы
и антишпионы, они воруют или наоборот не дают украсть часть дохода других игроков на производстве.

Лицензии - аналог вагонов. Кстати, вагоны и лицензии продаются за 25% стоимости (а не 70%, как в RN), поэтому запасать в них деньги не имеет особого смысла.
...
Хотя в активных гильдиях всё равно лучшая стратегия это держать самый короткий (часовой) интервал постоянно, потому что то-нибудь есть онлайн в игре значительную часть суток.
...
она получит на ней дополнительный бонус к ВО по итогам "выборов". Выигрывает та гильдия, которая больше всех возит. Поскольку клейм может быть только один, обычно выбирают заставу, которая
...
соревнуешься, то нет и смысла сильно спешить. А подвозы позволят поддерживать запасы на складах и не повышать ВО себе и другим игрокам. Кстати, такие задания иногда бывают заданиями на поставку
